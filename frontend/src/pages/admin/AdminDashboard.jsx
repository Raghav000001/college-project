...
function AdminDashboard() {
  ...
  const filteredEmployees = employees.filter((employee) => {
    const matchesSearch = `${employee.firstName} ${employee.lastName}`
      .toLowerCase()
      .includes(searchTerm);
    const matchesDepartment = selectedDepartments
      ? employee.department.toLowerCase() ===
        selectedDepartments.toLocaleLowerCase()
      : true;
        ...
        <div>
          <div className="flex flex-col sm:flex-row justify-between items-center mb-4 gap-4">
            ...
            <button
              ...
              className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-md text-sm font-medium transition-colors duration-300 w-full sm:w-auto"
            >
              Add New Employee
            </button>
          </div>
